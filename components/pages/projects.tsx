...
export const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Ongoing private (and soon public when there's more to it) project with assorted tools. Current highlight is a custom-made color picker for my Minecraft skin making needs--I realized I have free will and online tools weren't cutting it. Actually, you can interact with a very early and slightly buggy version of it in this portfolio! Enter 'color' in the URL bar to try it out. Updating soon with the correct version! Which I think I somehow lost...!",
