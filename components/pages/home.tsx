...
export const BrowserHome = () => {
    return (
        <motion.div
                  ...
                  >
                    <h1 className="text-4xl font-bold mb-6 text-gradient bg-clip-text text-transparent bg-gradient-to-r from-blue-300 to-purple-500 text-center">
                      hi, i'm carolyn
                    </h1>
                    <p className="text-xl mb-6 text-gray-300 text-center-left mx-40">
                      recent cs grad passionate about ai/ml, web dev, game dev, and with making the world a better place :)
                      <br /> <br />
                      {/* building apps that use ai for good + collaborative apps for a more connected (and fun) future! */}
                    </p>
